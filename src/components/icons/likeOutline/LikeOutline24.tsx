...
export default function LikeOutlineIcon({
    ...
    return (
        ...
        >
            <path d='M15.9918 4.00599C14.5405 4.06981 13.2389 4.64334 12.111 5.69952L11.994 5.813L11.8723 5.69501C10.6626 4.57606 9.2746 4 7.73438 4C4.57716 4 2 6.56027 2 9.71723C2 12.8046 3.12733 14.2688 8.18242 18.263L10.8704 20.3607C11.5345 20.8783 12.4655 20.8783 13.1296 20.3607L15.4937 18.5182L16.4269 17.7784C20.9647 14.144 22 12.676 22 9.71723C22 6.56027 19.4228 4 16.2656 4L15.9918 4.00599ZM16.2656 5.8C18.4314 5.8 20.2 7.55704 20.2 9.71723L20.1951 10.0108C20.1192 12.1674 19.1332 13.352 14.686 16.8631L12.0231 18.941C12.0095 18.9515 11.9905 18.9515 11.9769 18.941L9.6128 17.0984L8.73899 16.4066C4.59678 13.0977 3.8 11.9668 3.8 9.71723C3.8 7.55704 5.56863 5.8 7.73438 5.8C9.06729 5.8 10.2408 6.41758 11.3038 7.71525C11.6662 8.15771 12.3441 8.15426 12.702 7.70812C13.7389 6.41565 14.9087 5.8 16.2656 5.8Z' />
        </svg>
    );
}
